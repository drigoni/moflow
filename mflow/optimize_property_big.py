...
from mflow.models.utils import check_validity, check_cancer_validity, construct_mol, adj_to_smiles
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, default='qm9', choices=['qm9', 'zinc250k', 'cancer'],
                        help='dataset name')
